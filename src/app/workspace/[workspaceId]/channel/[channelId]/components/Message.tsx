...
import { useRemoveMessage } from "@/hooks/messages/useRemoveMessage";
...
const Editor = dynamic(
  () => import("@/components/Editor").then((component) => component.Editor),
  { ssr: false }
);
      ...
      <>
        ...
        <div
          className={cn(
            ...
            isRemovingMessage &&
              "bg-rose-500/5 transform transition-all scale-y-0 origin-bottom duration-200"
          )}
        >
